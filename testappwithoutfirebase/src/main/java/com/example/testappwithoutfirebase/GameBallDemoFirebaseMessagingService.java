 ...
 */
public class GameBallDemoFirebaseMessagingService extends FirebaseMessagingService {

    private static final String TAG = GameBallDemoFirebaseMessagingService.class.getSimpleName();
